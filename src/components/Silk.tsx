...
const SilkPlane = forwardRef<{ scale: THREE.Vector3; material: THREE.ShaderMaterial }, any>(({ uniforms }, ref) => {
  ...
  useFrame((_, delta) => {
    if (localRef.current && localRef.current.material) {
      localRef.current.material.uniforms.uTime.value += 0.1 * delta;
    }
  });
