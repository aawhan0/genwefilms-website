  ...
  return (
    <main className="bg-black text-white min-h-screen px-6 py-20">
      ...
      <div className="max-w-5xl mx-auto border border-white/10 rounded-[2.5rem] p-8 md:p-16 bg-white/[0.02] backdrop-blur-xl">
        ...
        {/* ✅ IMPORTANT INTRO (this was missing earlier) */}
        <p className="text-white/70 leading-relaxed mb-10">
          By using genwefilms.com, you agree to these Terms. If you do not agree, please discontinue use.
        </p>
        ...
        <div className="space-y-10 text-white/70 leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 list-disc pl-5">
              <li>Genwe Films shall not be liable for indirect, incidental, or consequential damages</li>
